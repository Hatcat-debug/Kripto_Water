...
-----------------------------------  WATER FIRST STEPS ------------------------------------------------------------------------------------------------------------
               ...
               1) Right click in hierarchy -> Effects -> KWS Water system
...
3) Restart unity (only in builtin rendering, post processing required)
---------------------------------------------------------------------------------------------------------------------------------------------------------------
...
WaterSystem.UseNetworkBuoyancy = true;
WaterSystem.UseNetworkTime = true;
WaterSystem.NetworkTime = ...  //your time in seconds
...
1.4.05
-fixed some import errors (asset.refresh)
-fixed compatibility with VFX graph (and rendering-pipeline.core)
-fixed "_CameraOpaqueTexture" issue
-fixed xbox support
-fixed point lights issue (when half of the water mesh is bright)
-fixed incorrect culling for custom meshes
-fixed "QualitySettings.maximumLODLevel" issue
-added native unity skybox support instead of custom cubemap baking

1.4.04
-fixed finite mesh performance issue
-fixed enviro3 support
-fixed ps5 support
...
1.3.0
-added river splines
-added performance profiles (with optimizations for potato PC)
-added third-party fog support for Enviro/Azure/WeatherMaker/Atmospheric height fog/Volumetric fog and mist2/COZY weather
...
-optimized water mesh vertices count (~x3 fewer vertices)
...
-fixed screen space reflection on macOS
...
-fixed crash on unity 2021.3 when disabling volumetric lighting
...
-Optimized volumetric lighting (all lights in one pass, instead of pass per light)
-Optimized buoyancy physics (and added new public API)
-Optimized foam rendering
-Optimized water shader
-Optimisations for 4k resolution rendering

-Added occlusion culling for water mesh/underwater pass/volumetric point/spot lights.
...
1.1.1
-Added water depth mask
-Added partial fog support (planar reflection doesn't support fog rendering)
-Added volumetric attenuation by depth
-Refactored volumetric lighting.
-Optimized volumetric lighting/underwater effect.


1.1.0
-Added buoyancy
-Added fluid simulation for static objects (river foam)
-Added dynamic waves
-Added rain effect
-Added macOS support (screen space reflection not yet working)
-Added finite mesh support (pools, etc)

-Optimization and refactoring of some shaders / code
-Fixed 100500 bugs and added new ones.


1.0.1
Fixed package manager errors.